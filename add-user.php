                    ...
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input autocomplete="off" class="form-control <?= (isset($_SESSION['mobile_error'])) ? 'is-invalid' : '' ?>" value="<?= isset($_SESSION["old_mobile"]) ? $_SESSION["old_mobile"] : "$mobile"; ?>" type="text" name="mobile" placeholder="017XXXXXXXX">
                        ...
                        <?php if ($task != 'edit') : ?>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" class="form-control <?= (isset($_SESSION['password_error'])) ? 'is-invalid' : '' ?>" type="password" name="password" placeholder="Set a password">
