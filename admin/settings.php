                            ...
                            <td scope="col">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="add_info.php?profile_id=<?= $profile_id ?>" class="dropdown-item" href="#">Information</a>
                                        <?php
                                        if ($profile_photo) { ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img src="../media/partners/<?= $partners['partner_image'] ?>" height="50" alt="<?= $partners['partner_name'] ?>"></td>
                                        ...
                                        <td scope="col">
                                            <a class="text-white" href="manage-partners.php?id=<?= $partners['id'] ?>&task=edit">
