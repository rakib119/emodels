...
if (!isset($_GET['profile_id'])) {
    ...
    $basic_model_info = mysqli_fetch_assoc(select_all('users', '*', "where profile_id ='$profile_id' "));
...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item" href="basic-information.php?profile_id=<?= $profile_id ?>">Upload profile picture</a>
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="<?= $basic_model_info['name'] ?>" readonly type="text">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label class="form-control-label">Basic Number: </label>
                                <input class="form-control" value="<?= $basic_model_info ['mobile'] ?>" readonly type="text">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label class="form-control-label">Optional Number: </label>
                                <input class="form-control" value="<?= $model_info['optional_number'] ?>" type="text" name="optional_number" placeholder="017********">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="<?= $model_info['price'] ?>" type="text" name="price">
                            </div>
                        </div>
                        <div class="col-lg-4">
